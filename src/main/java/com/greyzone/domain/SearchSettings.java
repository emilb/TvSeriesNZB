...
public class SearchSettings {
    ...
    public String getAllSearchAttributesGroupedAndOred() {
        StringBuffer sb = new StringBuffer();
        sb.append(getSearchAttributesGroupedOred(sources, sourceMap));
        sb.append(" ");
        sb.append(getSearchAttributesGroupedOred(languages, languageMap));
        sb.append(" ");
        sb.append(getSearchAttributesGroupedOred(formats, formatMap));
        sb.append(" ");
        sb.append(getSearchAttributesGroupedOred(subtitles, subtitleMap));
        return sb.toString();
    }
    ...
    private static String getSearchAttributesGroupedOred(List<String> keys, Map<String, String> map) {
        List<String> sAttribs = getSearchAttributes(keys, map);
    ...
    private static List<String> getSearchAttributes(List<String> keys, Map<String, String> map) {
