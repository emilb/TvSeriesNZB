...
public class SearchSettings {
	...
	static {
		...
		sourceMap.put("a:DVD", "videos~HD-DVD"); 
		sourceMap.put("a:Ray", "videos~Blu-Ray"); 
		...
		formatMap.put("a:Ray", "videof~Blu-Ray"); 
		formatMap.put("a:DVD", "videof~HD-DVD"); 
		formatMap.put("a:TS", "videof~HD.TS"); 
		formatMap.put("a:264", "videof~H.264"); 
